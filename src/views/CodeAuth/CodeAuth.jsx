...
export const CodeAuth = () => {
  ...
  const handleSendCode = (e) => {
    ...
    UserDataService.sendPasswordResetCode(formData.email)
      .then((response) => {
        if (response.data === "OK") {
          setError(<div className="alert alert-success">The reset code has been sent to your email.</div>);
        } else {
  ...
  const handleAuthCode = (e) => {
    ...
    UserDataService.checkPasswordResetCode(requestData.code).then((response) => {
