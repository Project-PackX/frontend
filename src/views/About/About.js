...
export const About = () => {
    ...
    const Person = ({ imgSrc, imgAlt, name, github, role }) => (
        <div className="col-md-2 about-logo-column">
            ...
            <a href={github} className="about-people-link">{name}</a>
    ...
    const SzeImage = () => (
        <img
            src={clickCount < maxClickCount
                ? require("../../assets/logos/sze.png")
                : require("../../assets/images/sze_2.webp")}
            alt="sze"
        ...
        <main>
            <div className="container about-container">
                <div className="row">
                    ...
                    <div className="col-md-7">
                        <Image imgSrc={require("../../assets/logos/pack_norm_black.svg").default} imgAlt="startup" className="about-img-right" />
                    </div>
                </div>
            </div>
            <div className="container about-container">
                <div className="row">
                    <div className="col-md-7">
                        <Image imgSrc={require("../../assets/images/undraw_in_no_time_-6-igu.svg").default} imgAlt="system" className="about-img-left" />
                    </div>
                    <Column
                        title="How it works?"
            ...
            <div className="container about-container">
                <div className="row">
                    ...
                    />
                    <div className="col-md-7">
                        <Image imgSrc={require("../../assets/images/undraw_environment_iaus.svg").default} imgAlt="electric" className="about-img-right" />
                    </div>
                </div>
            </div>
            <div className="about-person-container text-center">
                ...
                <div className="row justify-content-center about-logo-container">
                    <Person imgSrc={require("../../assets/people/karcsi.jpg")} imgAlt="Szakály Károly" name="Szakály Károly" github="https://github.com/szkly" role="DevOps and Backend" />
                    <Person imgSrc={require("../../assets/people/artur.jpg")} imgAlt="Friedrich Artúr" name="Friedrich Artúr" github="https://github.com/arturfriedrich" role="Frontend and UX Design" />
                    <Person imgSrc={require("../../assets/people/domi.jpg")} imgAlt="Szilágyi Dominik" name="Szilágyi Dominik" github="https://github.com/dominikszilagyi" role="Backend" />
                    <Person imgSrc={require("../../assets/people/zsombi.jpg")} imgAlt="Töreky Zsombor" name="Töreky Zsombor" github="https://github.com/tzsombi01" role="Backend" />
                    <Person imgSrc={require("../../assets/people/danci.jpg")} imgAlt="Székely Dániel" name="Székely Dániel" github="https://github.com/MrHumanRebel" role="Frontend and UX Design" />
                </div>
                <SzeImage />
            </div>
        </main>
