    ...
    return (
      <div className="container send-container">
        <div className="send-box">
          ...
          <Link to="/track" className="btn login-btn">
    ...
    <div className="package-details container">
      ...
      <div className="timeline">
        {stages.map((stage, index) => (
          <div key={index} className={`state-images ${stage === currentState ? "current" : ""}`}>
      ...
      <table className="package-table">
        <tbody>
          ...
          <tr>
            ...
            <td className="package-table-info">
              {selectedCurrency === "HUF" ? `${hufPrice} HUF` : selectedCurrency === "EUR" ? `${eurPrice} EUR` : `${usdPrice} USD`}
            </td>
          </tr>
          <tr>
