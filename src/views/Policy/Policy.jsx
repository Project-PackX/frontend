...
export const Policy = () => {
  return (
    <div className="policy-container">
      ...
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use PackX if you do not agree to
      ...
      <p>
        ...
        provision of the Company's stated services, in accordance with and subject to, prevailing law of hu. Any use of the above
      ...
      <p>
        Unless otherwise stated, PackX and/or its licensors own the intellectual property rights for all material on PackX. All
        intellectual property rights are reserved. You may access this from PackX for your own personal use subjected to restrictions
      ...
      <p>
        ...
        website. PackX does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of PackX,its agents and/or affiliates. Comments reflect the views and opinions of the person who
        post their views and opinions. To the extent permitted by applicable laws, PackX shall not be liable for the Comments or for
        any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </p>

      <p>
        PackX reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or
      ...
      <p>
        You hereby grant PackX a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of
      ...
      <p>
        ...
        us from the visibility of the hyperlink compensates the absence of PackX; and (d) the link is in the context of general
      ...
      <p>
        ...
        us by sending an e-mail to PackX. Please include your name, your organization name, contact information as well as the URL of
